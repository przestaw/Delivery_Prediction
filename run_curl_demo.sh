...
curl -s -X GET localhost:5000/api/info 
...
curl -s -X GET localhost:5000/api/prediction/models
...
curl -s -X GET localhost:5000/api/prediction/models/active 



sleep 0.2
echo '# get history'
curl -s -X GET localhost:5000/api/prediction/history 



sleep 0.2
echo '# get summary'
curl -s -X GET localhost:5000/api/prediction/summary 
